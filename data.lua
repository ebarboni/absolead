...
function createStrat()
    return  {
        ...
        [1985] = {
            [0] ="<html><body><h1>SimpleHTML Demo: Ambush</h1><p>Among every ability a rogue has at his disposal,<br/>Ambush is without a doubt the hardest hitting Rogue ability.</p></body></html>"
        }
    }
